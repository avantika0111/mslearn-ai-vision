...
def main():
    ...
    try:
        ...
        cv_client = sdk.VisionServiceOptions(endpoint=ai_endpoint, key=ai_key)
...
def AnalyzeImage(image_file, cv_client):
    ...
    image_analyzer = sdk.ImageAnalyzer(service_options=cv_client, vision_source=image, analysis_options=analysis_options)
